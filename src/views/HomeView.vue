        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex space-x-8">
            ...
            <div class="relative group">
              ...
              <div
                class="absolute left-0 mt-0 pt-6 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible hover:opacity-100 hover:visible transition-all duration-300"
              >
...
import spidermanImage from '../assets/comics/spiderman.jpg'
...
const getComicImage = (comic) => {
  if (comic.title.toLowerCase().includes('spider')) {
...
const fetchData = async () => {
  ...
  try {
    ...
    comics.value = comicsResponse.data.map(comic => ({
      ...
      description: comic.description || (
        comic.title.toLowerCase().includes('spider')
          ? "Peter Parker's journey continues in this thrilling new adventure. Follow Spider-Man as he swings through the city, facing new challenges and protecting those in need."
          : comic.title.toLowerCase().includes('academia')
            ? "Izuku Midoriya is a young boy who dreams of becoming a hero, despite being born without any powers in a world where they are common."
            : "An exciting new comic adventure awaits!"
      )
    }))

    // Process featured comics
    ...
    console.log('Fetched comics:', comics.value) // Debug log
