<template>
  <div class="min-h-screen bg-gradient-to-br from-white via-yellow-50 to-yellow-100 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div class="bg-white rounded-xl shadow-xl p-8 space-y-6">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <button 
            type="submit"
            :disabled="isLoading"
            class="w-full flex justify-center py-3 px-4 rounded-lg text-sm font-medium text-yellow-900 bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 disabled:bg-yellow-200 disabled:cursor-not-allowed transition-colors"
          >
    ...
    <div class="absolute top-[calc(100%-13rem)] right-0 -z-10 transform-gpu blur-3xl" aria-hidden="true">
