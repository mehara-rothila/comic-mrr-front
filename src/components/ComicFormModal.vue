      ...
      <form @submit.prevent="handleSubmit">
        <div class="space-y-3">
          ...
          <div>
            ...
            >
            <p class="text-xs text-yellow-600 mt-1">Max size: 2MB. Formats: JPG, PNG. (Optional)</p>
            
            <!-- Image Preview -->
            <div v-if="imagePreview || (props.comic && props.comic.image_url)" class="mt-2">
              <img 
                :src="imagePreview || props.comic?.image_url" 
...
onMounted(() => {
  if (props.comic) {
    ...
    if (props.comic.image_url) {
      imagePreview.value = props.comic.image_url
    }
  }
})
